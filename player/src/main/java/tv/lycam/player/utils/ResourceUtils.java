    ...
    public static int getResourceIdByName(Context context, String className, String name) {
        ...
        if (context == null) {
            ...
            try {
                ...
                Log.e(TAG, String.format("ClassNotFoundException: class=%s fieldname=%s", className, name));
            } catch (IllegalArgumentException var8) {
                Log.e(TAG, String.format("IllegalArgumentException: class=%s fieldname=%s", className, name));
            } catch (SecurityException var9) {
                Log.e(TAG, String.format("SecurityException: class=%s fieldname=%s", className, name));
            } catch (IllegalAccessException var101) {
                Log.e(TAG, String.format("IllegalAccessException: class=%s fieldname=%s", className, name));
            } catch (NoSuchFieldException var11) {
                Log.e(TAG, String.format("NoSuchFieldException: class=%s fieldname=%s", className, name));
            }
