...
public class AudioMngHelper {
    private static AudioMngHelper sMngHelper;
    ...
    public static AudioMngHelper instance(Context context) {
        synchronized (AudioMngHelper.class) {
            if (sMngHelper == null) {
                sMngHelper = new AudioMngHelper(context);
            }
        }
        return sMngHelper;
    }
    ...
    public AudioMngHelper addVoiceSystem() {
        mAudioManager.adjustStreamVolume(NOW_AUDIO_TYPE, AudioManager.ADJUST_RAISE, NOW_FLAG);
        return this;
    }

    public AudioMngHelper subVoiceSystem() {
        mAudioManager.adjustStreamVolume(NOW_AUDIO_TYPE, AudioManager.ADJUST_LOWER, NOW_FLAG);
        return this;
    }
    ...
    public int addVoice100() {
        ...
        a = a <= 0 ? 0 : a;
        a = a >= 100 ? 100 : a;
        mAudioManager.setStreamVolume(NOW_AUDIO_TYPE, a, NOW_FLAG);
        return get100CurrentVolume();
    }
